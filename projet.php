  ...
  <div class="container">
    <div class="project-detail-grid">
      ...
      <div class="project-sidebar">
        <div class="project-info-card reveal right">
          <h3>Données du chantier</h3>
          <dl>
            <?php foreach ([
              'Catégorie'    => $p['cat'],
              'Localisation' => $p['city'],
              'Année'        => $p['year'],
              'Surface'      => $p['surface'],
              'Durée travaux'=> $p['duration'],
              'Maître d\'ouvrage' => $p['client'],
              'Statut'       => $p['status'],
            ] as $k => $v): ?>
            <div class="info-row">
              <dt><?= $k ?></dt>
        ...
        <div class="project-info-card reveal right reveal-delay-2" style="background:rgba(0,174,239,.06);border:1.5px solid rgba(0,174,239,.3)">
          <h3>Chantier similaire en vue ?</h3>
          <p style="font-size:14px;color:#6b7280;margin-bottom:16px;line-height:1.7">Transmettez-nous votre programme ou vos plans. Notre bureau d'études vous retourne une offre technique et financière sous 48h ouvrées, sans engagement.</p>
          <a href="contact.php" class="btn btn-gold" style="width:100%;justify-content:center">Déposer mon dossier →</a>
        </div>

        <a href="realisations.php" class="btn btn-outline" style="justify-content:center;width:100%">
...
<section class="cta-banner">
  <div class="container">
    <h2 class="reveal up">UN PROJET SIMILAIRE<br>À RÉALISER ?</h2>
    <p class="reveal up reveal-delay-1">Nos ingénieurs et conducteurs de travaux sont prêts à prendre en charge votre chantier. Offre de prix sous 48h sur présentation de vos plans ou de votre programme.</p>
    <div class="cta-btns reveal up reveal-delay-2">
      <a href="contact.php" class="btn btn-gold">Soumettre mon projet →</a>
      <a href="realisations.php" class="btn btn-outline-white">Voir toutes nos références</a>
    </div>
  </div>
</section>
