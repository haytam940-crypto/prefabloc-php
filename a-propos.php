...
<section class="section">
  <div class="container">
    <div class="sec-head">
      <span class="sec-tag reveal up">Direction technique</span>
      <h2 class="sec-title reveal up reveal-delay-1">LES INGÉNIEURS<br>QUI PILOTENT VOS CHANTIERS</h2>
      <div class="divider-line reveal up reveal-delay-2"></div>
      <p class="sec-sub reveal up reveal-delay-3">Des profils formés dans les meilleures écoles d'ingénieurs du Maroc, aguerris par des années de terrain sur des projets d'envergure nationale.</p>
    </div>
    <div class="team-grid">
      <div class="team-card reveal up reveal-delay-1">
        <div class="team-avatar">AB</div>
        <h3>Amine Benali</h3>
        <div class="role">Directeur Général — Ing. Génie Civil EHTP</div>
      ...
      <div class="team-card reveal up reveal-delay-2">
        <div class="team-avatar" style="background:var(--green)">SM</div>
        <h3>Sara Moussaoui</h3>
        <div class="role">Directrice des Opérations — Ing. BTP EMI</div>
        <p>Responsable de la coordination entre les études, les approvisionnements et les équipes terrain. Experte en planification PERT/Gantt et gestion de sous-traitants spécialisés. A supervisé la réalisation du complexe Technopark Casablanca, 6 500 m² livrés en 28 mois.</p>
      </div>
      <div class="team-card reveal up reveal-delay-3">
        <div class="team-avatar" style="background:var(--gold);color:var(--navy-dark)">YH</div>
        <h3>Youssef Hajji</h3>
        <div class="role">Directeur Technique — Ing. Structures IAV Hassan II</div>
        <p>Responsable du bureau d'études interne : notes de calcul béton armé, plans d'exécution, conformité RPS 2011 et coordination avec les laboratoires agréés. Référent technique pour les projets industriels et les ouvrages soumis à charges dynamiques.</p>
      </div>
    </div>
  </div>
</section>
